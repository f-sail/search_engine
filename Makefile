...
objs_server := bin/_server.o  bin/log4cpp.o  bin/Acceptor.o  bin/Cache.o  bin/Configuration.o  bin/Dictionary.o  bin/EventLoop.o  bin/InetAddress.o  bin/KeyRecommander.o  bin/SearchEngineServer.o  bin/Socket.o  bin/SocketIO.o  bin/MessageHandler.o  bin/SplitTool.o  bin/TaskQueue.o  bin/TcpConnection.o  bin/TcpServer.o  bin/TimerFd.o  bin/ThreadPool.o  bin/WebPageQuery.o  bin/WebPageSercher.o
