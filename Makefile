...
objs_server := bin/_server.o  bin/log4cpp.o  bin/Acceptor.o  bin/Configuration.o  bin/EventLoop.o  bin/InetAddress.o  bin/Socket.o  bin/SocketIO.o  bin/TaskQueue.o  bin/TcpConnection.o  bin/TcpServer.o  bin/ThreadPool.o
